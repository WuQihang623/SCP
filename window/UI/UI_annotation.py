...
class UI_Annotation(QFrame):
    ...
    def init_UI(self):
        ...
        self.loadActivateAnnotation_btn = QPushButton("主动标注")
        self.clearAnnotation_btn = QPushButton('清空标注')
        self.annotaion_layout = QGridLayout()
        self.annotaion_layout.addWidget(self.annotationTree, 0, 0, 1, 4)
        self.annotaion_layout.addWidget(self.label1, 1, 0, 1, 1)
        self.annotaion_layout.addWidget(self.annofolderselector, 1, 1, 1, 3)
        self.annotaion_layout.addWidget(self.loadAnnotation_btn, 2, 0, 1, 1)
        self.annotaion_layout.addWidget(self.loadActivateAnnotation_btn, 2, 1, 1, 1)
        self.annotaion_layout.addWidget(self.save_btn, 2, 2, 1, 1)
        self.annotaion_layout.addWidget(self.clearAnnotation_btn, 2, 3, 1, 1)
