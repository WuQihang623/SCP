...
class UI_Microenv(QFrame):
    ...
    def init_UI(self):
        ...
        box_layout.addWidget(self.tumorNum_label, 7, 0, 1, 2)
        box_layout.addWidget(self.lymphNum_label, 8, 0, 1, 2)
        box_layout.addWidget(self.neutrophilsNum_label, 9, 0, 1, 2)
        box_layout.addWidget(self.stromaNum_label, 10, 0, 1, 2)
        box_layout.addWidget(line3, 11, 0, 1, 2)

        # box_layout.addWidget(line1, 4, 0, 1, 2)
        box_layout.addWidget(show_label, 12, 0, 1, 1)
        box_layout.addWidget(self.showCombox, 12, 1, 1, 1)
        ...
        box_layout.addWidget(self.show_hierarchy_mask_checkbox, 15, 0, 1, 1)

        box_layout.addItem(null, 16, 0, 1, 2)
