...
class UI_PDL1(QFrame):
    ...
    def init_UI(self):
        ...
        box_layout.addWidget(self.loadpdl1_btn, 2, 0, 1, 1)
        ...
        box_layout.addWidget(self.tumorPosNum_label, 8, 0, 1, 2)
        box_layout.addWidget(self.tumorNegNum_label, 9, 0, 1, 2)
        box_layout.addWidget(self.immuPosNum_label, 10, 0, 1, 2)
        box_layout.addWidget(self.immuNegNum_label, 11, 0, 1, 2)
        box_layout.addWidget(self.tps_label, 12, 0, 1, 2)
        box_layout.addWidget(self.cps_label, 13, 0, 1, 2)
        box_layout.addWidget(line3, 14, 0, 1, 2)
