...
class UI_PDL1(QFrame):
    ...
    def init_UI(self):
        ...
        box_layout.addWidget(self.pdl1_btn, 3, 0, 1, 2)
        ...
        box_layout.addWidget(line2, 5, 0, 1, 2)
        box_layout.addWidget(label, 6, 0, 1, 2)
        box_layout.addWidget(self.tumorPosNum_label, 7, 0, 1, 2)
        box_layout.addWidget(self.tumorNegNum_label, 8, 0, 1, 2)
        box_layout.addWidget(self.immuPosNum_label, 9, 0, 1, 2)
        box_layout.addWidget(self.immuNegNum_label, 10, 0, 1, 2)
        box_layout.addWidget(self.tps_label, 11, 0, 1, 2)
        box_layout.addWidget(self.cps_label, 12, 0, 1, 2)
        box_layout.addWidget(line3, 13, 0, 1, 2)

        # box_layout.addWidget(line1, 4, 0, 1, 2)
        box_layout.addWidget(show_label, 14, 0, 1, 1)
        box_layout.addWidget(self.showCombox, 14, 1, 1, 1)
        box_layout.addWidget(showNucleiType_Label, 15, 0, 1, 1)
        box_layout.addWidget(self.showNucleiType_Combox, 15, 1, 1, 1)
        box_layout.addWidget(showRegionType_Label, 16, 0, 1, 1)
