...
####
def process(pred_map, nr_types=None, return_centroids=False, type_map=None):
    ...
    if return_centroids or nr_types is not None:
        ...
        for inst_id in inst_id_list:
            ...
            inst_map = inst_map[
                       inst_bbox[0][1]: inst_bbox[1][1], inst_bbox[0][0]: inst_bbox[1][0]
                       ]
            ...
            if inst_type == 0:  # ! pick the 2nd most dominant if exist
                ...
                if len(type_list) > 1:
                    if type_list[1][0] == 0:
                        ...
                        inst_type = inst_type_crop[inst_map_crop]
                        inst_type = np.mean(inst_type, axis=0)
                        inst_type = np.argsort(inst_type)[::-1][1]
                    else:
                        inst_type = type_list[1][0]
                else:
                    inst_type_crop = type_map[rmin:rmax, cmin:cmax]
